...
'''
'''
Modificado por: Andrés Felipe Lagos
'''
...
for FILE_NAME in fileList:
	...
	if(user_input == 'N' or user_input == 'n'):
		...
		mv=0 #data.attrs['MissingValue']
		offset= 0 #data.attrs['Offset']
		scale= 0 #data.attrs['ScaleFactor']
